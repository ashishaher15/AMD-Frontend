...
export default function DoctorDetail() {
    ...
    const fetchDoctor = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `${API_ENDPOINTS.DOCTOR.DETAIL}/${email}`,
          {
  ...
  const handleCheckAvailability = async () => {
    ...
    setIsAvailable(null);
    try {
      const response = await axios.get(API_ENDPOINTS.APPOINTMENT.CHECK, {
  ...
  const handleBookAppointment = async () => {
    ...
    try {
      const bookResponse = await axios.post(
        API_ENDPOINTS.APPOINTMENT.BOOK,
      ...
      if (bookResponse.data.success) {
        ...
        console.log(
          "Appointment booking successful, resetting appointment date."
        );
        setAppointmentDate("");
        setIsAvailable(null);
      } else {
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 transform transition-all duration-300 hover:shadow-xl">
        ...
        {isAvailable === false && (
          <div className="bg-red-50 border border-red-200 rounded-md p-3 mb-4 flex items-center">
            ...
            <p className="text-red-700 font-medium">
              This time slot is not available. Please try another.
            </p>
          </div>
        )}
        ...
        <div className="mt-6 text-sm text-gray-500">
          <p className="flex items-center">
            ...
            You can view your booked appointments in the "My Appointments"
            section.
          </p>
        </div>
      </div>
