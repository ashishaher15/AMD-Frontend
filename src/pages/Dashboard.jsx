  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const response = await axios.get(API_ENDPOINTS.USER.GET_USERS);
        ...
        if (currentUser) {
          ...
          if (currentUser.documents && currentUser.documents.pdf) {
            ...
            try {
              ...
              if (
                typeof currentUser.documents.pdf === "object" &&
                currentUser.documents.pdf.data
              ) {
                ...
                console.log(
                  "Created PDF blob URL from Buffer data:",
                  pdfBlobUrl
                );
              ...
              // Handle the case when PDF is a base64 string
                ...
                try {
                  ...
                  setDebugInfo((prev) => ({
                    ...prev,
                    conversionError: base64Error.message,
                  }));
                  toast.error("Failed to decode base64 PDF data");
                }
              } else {
                console.error(
                  "PDF data is in an unsupported format:",
                  typeof currentUser.documents.pdf
                );
              ...
              setDebugInfo((prev) => ({
                ...prev,
                conversionError: pdfError.message,
              }));
        ...
        setError(
          "We're having trouble fetching your information. Please try again."
        );
              ...
              >
                ...
                {pdfUrl ? (
                  ...
                  <p className="mt-4 text-gray-500 italic">
                    No medical records PDF available
                  </p>
                )}
                ...
                <div className="space-y-4">
                  {user?.documents?.prescription?.fileName ? (
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <button
                        onClick={() =>
                          window.open(user.documents.prescription.url, "_blank")
                        }
                  ...
                  {user?.documents?.medicalReport?.fileName ? (
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <button
                        onClick={() =>
                          window.open(
                            user.documents.medicalReport.url,
                            "_blank"
                          )
                        }
                        className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
                  ...
                  {user?.documents?.insurance?.fileName ? (
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <button
                        onClick={() =>
                          window.open(user.documents.insurance.url, "_blank")
                        }
                        className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
